...
docker load -i /root/images/kapp-controller-0.23.0.tar.gz
docker tag projects.registry.vmware.com/tkg/kapp-controller:v0.23.0_vmware.1 ${HOSTNAME}/tkg/kapp-controller:v0.23.0_vmware.1
docker push ${HOSTNAME}/tkg/kapp-controller:v0.23.0_vmware.1
